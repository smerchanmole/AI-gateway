...
(() => {
  ...
  const rows = [
    ...
    ["usa el origen del Workbench que publica", "use the Workbench origin that publishes", "usa l'origine del Workbench che pubblica"],
    ...
    ["AI Workbench · próxima fase", "AI Workbench · next phase", "AI Workbench · fase successiva"],
